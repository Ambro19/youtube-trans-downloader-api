...
# from pathlib import Path
# from youtube_transcript_api import YouTubeTranscriptApi
# from database import TranscriptDownload, get_db, engine, SessionLocal, create_tables
...
# # Audio/Video quality mappings
# AUDIO_QUALITY_MAP = {
#     'high': 'bestaudio[ext=m4a]/best[height<=720]',
#     'medium': 'bestaudio[ext=m4a]/best[height<=480]', 
#     'low': 'worstaudio[ext=m4a]/worst[height<=360]'
# }
...
# # =============================================================================
# # AUDIO/VIDEO DOWNLOAD FUNCTIONS
# # =============================================================================

# def download_audio_with_ytdlp(video_id: str, quality: str = "medium") -> Optional[str]:
#     """
...
#         quality_format = AUDIO_QUALITY_MAP.get(quality, AUDIO_QUALITY_MAP["medium"])
...
#             "--extract-audio",
#             "--audio-format", "mp3",
#             "--audio-quality", "0" if quality == "high" else "5" if quality == "medium" else "9",
...
# def download_video_with_ytdlp(video_id: str, quality: str = "720p") -> Optional[str]:
#     """
...
#     try:
#         url = f"https://www.youtube.com/watch?v={video_id}"
#         quality_format = VIDEO_QUALITY_MAP.get(quality, VIDEO_QUALITY_MAP["720p"])
        
#         # Create temporary directory
#         temp_dir = tempfile.mkdtemp()
#         output_template = os.path.join(temp_dir, f"{video_id}_video.%(ext)s")
...
#             # Find the downloaded file
#             for filename in os.listdir(temp_dir):
#                 if filename.startswith(f"{video_id}_video"):
#                     return os.path.join(temp_dir, filename)
...
# def root():
#     """Root endpoint - API health check"""
#     return {"message": "YouTube Transcript Downloader API with Audio/Video Support", "status": "running", "version": "2.1.0"}
...
# def health():
#     """Health check endpoint for monitoring"""
#     return {"status": "healthy", "timestamp": datetime.utcnow().isoformat(), "features": ["transcripts", "audio", "video"]}
...
# A FastAPI-based SaaS application for downloading YouTube transcripts with subscription management.
...
#     title="YouTube Transcript Downloader API", 
#     version="2.0.0",
#     description="A SaaS application for downloading YouTube transcripts with subscription management"
# )
...
#     Used by frontend payment forms that don't specify a plan
#     """
#     try:
#         amount = 9.99
#         plan_name = "pro"
...
#     Args:
#         plan_type: Either 'pro' or 'premium'
    
#     Returns:
#         Payment intent details for frontend payment processing
#     """
#     try:
#         # Plan configuration
#         plans = {
...
#     Verifies payment with Stripe and updates user's subscription tier
#     """
#     try:
...
#                 current_user.subscription_tier = 'premium'
#             else:
#                 current_user.subscription_tier = 'pro'  # Default fallback
...
#     Returns raw transcript output for debugging purposes
#     """
#     result = get_transcript_with_ytdlp(video_id, clean=False)
#     if not result:
#         raise HTTPException(status_code=404, detail="Transcript not found or parsing failed")
#     return {"video_id": video_id, "raw": result[:3000]}  # Limit output length

# @app.get("/downloads/")
# def recent_downloads(limit: int = 10, db: Session = Depends(get_db)):
#     """
#     Admin endpoint to view recent transcript downloads
    
#     Useful for monitoring usage and debugging issues
#     """
#     downloads = db.query(TranscriptDownload).order_by(TranscriptDownload.created_at.desc()).limit(limit).all()
#     return [
#         {
