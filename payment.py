...
#     # Build session params with completely disabled Link payment method
#     try:
#         session_params = {
#             "mode": "subscription",
#             "customer": customer_id,  # Always use customer ID, never email
...
#             # COMPLETE Link disabling - multiple approaches to ensure consistency
#             "payment_method_types": ["card"],  # Only allow cards
#             "automatic_payment_methods": {"enabled": False},  # Disable automatic detection
            
#             # Force customer to use card form instead of saved payment methods
#             "payment_method_options": {
#                 "card": {
#                     "request_three_d_secure": "automatic",
#                     "setup_future_usage": None  # Don't save for future use (prevents Link)
#                 }
#             },
            
#             # Additional parameters to prevent Link
#             "customer_update": {
#                 "shipping": "never"  # Don't update customer shipping (Link feature)
#             },
            
#             # Force new payment method entry (bypass any saved methods including Link)
#             "payment_method_collection": "if_required",
            
#             # Custom success/cancel URLs to ensure clean flow
#             "locale": "en"  # Force English to avoid localization issues
#         }
